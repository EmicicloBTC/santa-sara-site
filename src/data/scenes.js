...
export const scenes = [
  ...
  },
  {
    id: "scene-1-second",
    title: "Tavolo · Natale",
    image: "/images/scenes/scene-1-second.png",
    imageMobile: "/images/scenes/scene-1-second-mobile.png",
    ...
    hotspotsMobile: [
      ...
      { productId: "gift-giving", x: 60, y: 40, r: 7 },
      { productId: "mid-winter", x: 42, y: 62, r: 6 },
      { productId: "dragonbell", x: 72, y: 64, r: 7 },
    ],
  },
  {
    id: "scene-1-focus-dragonbell",
    type: "productFocus",
    title: "Dragonbell",
    productId: "dragonbell",
    productImageIndex: 2,
  ...
  {
    id: "scene-3-focus-baroque-clash",
    type: "productFocus",
    title: "Baroque Clash",
    productId: "baroque-clash",
    productImageIndex: 2,
  ...
  {
    id: "scene-4-focus-kentucky-73",
    type: "productFocus",
    title: "Kentucky '73",
    productId: "kentucky-73",
    productImageIndex: 2,
  ...
  {
    id: "scene-1-bis-focus-dandy-land",
    type: "productFocus",
    title: "Dandy Land",
  ...
  {
    id: "scene-12-focus-padded-dynasty",
    type: "productFocus",
    title: "Padded Dynasty",
    productId: "padded-dynasty",
    productImageIndex: 2,
  ...
  {
    id: "scene-13-focus-iris-apfel",
    type: "productFocus",
    title: "Iris Apfel",
    productId: "iris-apfel",
    productImageIndex: 2,
  ...
  },
  {
    ...
    alt: "Tavolo con vaso Cohort 03 a sinistra e palla Back To Velvet a destra",
    hotspots: [
      { productId: "cohort-03", x: 34, y: 55, r: 7 },
      { productId: "back-to-velvet", x: 66, y: 52, r: 6 },
    ],
    hotspotsMobile: [
  ...
  {
    id: "scene-14-focus-cohort-03",
    type: "productFocus",
    title: "Cohort 03",
    productId: "cohort-03",
    productImageIndex: 2,
    alt: "Cohort 03 — vaso decorato a mano",
    hotspots: [],
  },
  {
    id: "scene-15",
